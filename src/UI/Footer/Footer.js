      ...
      <div className={classes.footer}>
        <div className={classes.bar1}>
          ...
          <div className={classes.Limousine}>
            <div className={classes.titleLimousine}>Xe Limousine</div>
            <br />
        ...
        <div className={classes.bar2}>
          ...
          <div className={classes.Garage}>
            <div className={classes.titleGarage}>Nhà xe</div>
            <br />
            <div>Xe Sao Việt</div>
            <br />
        ...
        <div className={classes.bar3}>
          ...
          <div className={classes.Certified}>
            <div className={classes.titleCertified}>Chứng nhận</div>
            <br />
            <img
              className={classes.logo1}
              src={require("../../image/certificate0.png")}
              alt=""
            />
            <br />
            <img
              className={classes.logo2}
              src={require("../../image/certificate1.png")}
              alt=""
            />
            <br />
            <img
              className={classes.logo3}
              src={require("../../image/dangkybocongthuong.png")}
              alt=""
            />
            <br />
            <img
          ...
          <div className={classes.Download}>
            ...
            <img
              ...
              src={require("../../image/googleplay.png")}
              alt=""
            />
          </div>
        </div>
        ...
        <div className={classes.bar4}>
          <div className={classes.License}>
            ...
            <div>
              Địa chỉ: Lầu 8 Tòa nhà CirCO, 222 Điện Biên Phủ, Quận 3, TP. Hồ
              Chí Minh, Việt Nam
            </div>
            <div>
